...
#adding widgets to tkinter window
   color_frame=LabelFrame(root, text='Color', font=('arial', 15), bd=5, relief='ridge', bg='white')
   color_frame.place(x=0,y=0, width=85, height=290)
   ...
   clear_button.place(x=2.5, y=440)
...
# create a scale for pen and eraser size.
   ...
   scale_frame.place(x=10, y=500, height=200, width=70)
